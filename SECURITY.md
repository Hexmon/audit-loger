...
## Reporting
If you discover a security issue, please email security@hexmon.example. Do not open a public issue.
...
- Prefer minimal dependencies in `@hexmon/audit-core` and review transitive updates.
