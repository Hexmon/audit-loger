...
## Reporting
If you discover a security issue, please email security@hexmon_tech.example. Do not open a public issue.
...
- Prefer minimal dependencies in `@hexmon_tech/audit-core` and review transitive updates.
